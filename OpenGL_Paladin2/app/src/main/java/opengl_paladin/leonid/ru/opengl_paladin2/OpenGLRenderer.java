package opengl_paladin.leonid.ru.opengl_paladin2;
...
public class OpenGLRenderer implements Renderer {
    ...
    public void onSurfaceCreated(GL10 arg0, EGLConfig arg1) {
        ...
        paladin.currDirection = 2;
        prepareData();
        // bindData();
        createViewMatrix();
        paladin.SetTexture(0, 0);
    }
...
//сбрасываем model матрицу
        ...
        if(currTime - lastTime > 80)
        {
            ...
            paladin.SetTexture(paladin.currTexture, paladin.currDirection);
            myI++;
        }
        if(myI % 50 == 0)
            paladin.currDirection = (paladin.currDirection + 1) % 8;
